            ...
            <div>
              ...
              <div className="mt-8 flex space-x-4">
                <button
                  ...
                  className={`w-48 bg-primary/30 text-primary rounded-full py-3 text-base font-medium hover:bg-primary/40 transition-color ${
                    isRepButtonVisible ? "" : "hidden"
                  }`}
                >
                  Rep Complete
                </button>
